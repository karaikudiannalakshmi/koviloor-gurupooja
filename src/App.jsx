...
const MONTH_STARTS = {
  'சித்திரை':new Date('2026-04-14'),'வைகாசி':new Date('2026-05-16'),
  'ஆனி':new Date('2026-06-16'),'ஆடி':new Date('2026-07-18'),
  'ஆவணி':new Date('2026-08-18'),'புரட்டாசி':new Date('2026-09-18'),
  'ஐப்பசி':new Date('2026-10-19'),'கார்த்திகை':new Date('2026-11-18'),
  'மார்கழி':new Date('2026-12-17'),'தை':new Date('2027-01-16'),
  'மாசி':new Date('2027-02-14'),'பங்குனி':new Date('2027-03-16'),
};
// Tamil month date ranges 2026-27
const TAMIL_MONTH_RANGES = [
  ['சித்திரை', '2026-04-14', '2026-05-15'],
  ['வைகாசி',  '2026-05-16', '2026-06-15'],
  ['ஆனி',     '2026-06-16', '2026-07-17'],
  ['ஆடி',     '2026-07-18', '2026-08-17'],
  ['ஆவணி',   '2026-08-18', '2026-09-17'],
  ['புரட்டாசி','2026-09-18', '2026-10-18'],
  ['ஐப்பசி',  '2026-10-19', '2026-11-17'],
  ['கார்த்திகை','2026-11-18','2026-12-16'],
  ['மார்கழி', '2026-12-17', '2027-01-15'],
  ['தை',      '2027-01-16', '2027-02-13'],
  ['மாசி',    '2027-02-14', '2027-03-15'],
...
const printLabels = (saints) => {
  ...
  const css = [
    ...
    '}',
    '.guru-ref { font-size: 7.5px; color: #999; border-bottom: 1px dotted #ddd; padding-bottom: 2px; margin-bottom: 3px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }',
    '.to-line { font-size: 9px; margin-bottom: 1px; }',
    '.name { font-size: 13px; font-weight: bold; margin-bottom: 2px; line-height: 1.2; }',
    '.addr { font-size: 11px; line-height: 1.4; overflow: hidden; }',
    '.from-stamp { font-size: 7.5px; color: #666; border-top: 1px dotted #ddd; margin-top: 2px; padding-top: 2px; text-align: right; }',
    'h1 { font-size: 14px; margin-bottom: 4px; color: #92400e; }',
    'h2 { font-size: 11px; font-weight: normal; color: #666; margin-bottom: 4mm; }',
    '@media print {',
